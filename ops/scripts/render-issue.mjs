import { escapeHtml, inline, loadIssue, todayInIST, writeFile } from "./lib.mjs";
...
<html lang="en">
  ...
  <body>
    <header class="cover">
      <nav class="topline" aria-label="Issue metadata"><a class="brand" href="#top">Studying the Masters</a><span>Issue ${String(issue.issueNumber).padStart(3, "0")}</span><span>${escapeHtml(issue.displayDate)}</span></nav>
